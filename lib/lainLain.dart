...
class MyApp_lain extends StatefulWidget {
  @override
  _MyAppState createState() => _MyAppState();
}

class _MyAppState extends State<MyApp_lain> {
  Future<List<dynamic>> _fecthDataUsers() async {
    var result = await http.get(Uri.parse(
        'https://restserver.cirebonkota.go.id/etuku/perkomoditas/appkey/8wc4oog48ocow4kso040os0skk4sgc04/id/5'));
